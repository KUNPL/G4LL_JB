...
//	TFile *openFile = new TFile("../data/rawData_H_He_Li_600_10000.root", "READ");

	Int_t eventID, trackID, pID, pdg, parentID, sEventID, sTrackID, isSiCsI, detID;
	Double_t hitTime, energyInit, edep, edep1, edep2, edep3, edep4, edep5;
  ...
  TH2F *h_dE_E = new TH2F("h_dE_E","E1 vs E_{Total} (E1+E2);E_{Total};E1",900,0,600,280,0,300);
  TH2F *h_dE_E_veto = new TH2F("h_dE_E_veto","E1 vs E_{Total} (E1+E2) with veto;E_{Total};E1",900,0,600,280,0,300);
